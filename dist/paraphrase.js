...
var Paraphrase = /** @class */ (function () {
    function Paraphrase(access_token) {
        var _this = this;
        this.getParaphrase = function (text) { return __awaiter(_this, void 0, void 0, function () {
            var response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("https://api.ai21.com/studio/v1/paraphrase", {
                                headers: {
